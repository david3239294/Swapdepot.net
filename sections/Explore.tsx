...
const exploreWorlds = [
  ...
  <motion.div
    variants={fadeIn("right", "spring", index * 0.0, 0.75)}
  ...
  >
    ...
    {active !== id ? (
      ...
      >
        <div className="flex justify-center items-center w-[60px] h-[80px] rounded-[24px] mb-[16px] glassmorphism">
          <img src="/headset.svg" alt="headset" className="w-1/2 h-1/2 object-contain" />
        </div>
        <p className="font-normal text-[16px] leading-[20px] text-white uppercase"></p>
  ...
  return (
    <section className="sm:p-16 px-6 py-12" id="explore">
      <motion.div
        ...
        >
          {Array.from("| Multi-Chain").map((char, index) => (
        ...
        >
          <>Choose between any 20 chains available on our swap</>
        </motion.p>
