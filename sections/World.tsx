	...
	return (
		<section className="sm:p-16 px-6 py-12 relative z-10">
			...
			>
				...
				>
					{Array.from("Trusted | Reliable insane speed").map((char, index) => (
						<motion.span
				...
				>
					 Use the swap ANYWHERE in the world
				</motion.p>
				<motion.div
				...
				>
					...
					<div className="absolute bottom-[20%] right-[15%] w-[70px] h-[70px] p-[6px] rounded-full bg-[blue]">
						<img src="/people-01.png" alt="people" className="w-full h-full" />
					</div>
					<div className="absolute top-1/2 left-[45%] w-[70px] h-[70px] p-[6px] rounded-full bg-[Green]">
						<img src="/people-02.png" alt="people" className="w-full h-full" />
					</div>
					<div className="absolute top-[10%] left-[10%] w-[70px] h-[70px] p-[6px] rounded-full bg-[yellow]">
						<img src="/people-01.png" alt="people" className="w-full h-full" />
					</div>
				</motion.div>
